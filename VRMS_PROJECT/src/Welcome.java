...
public class Welcome extends javax.swing.JFrame {
    ...
    public void mouseEntered(java.awt.event.MouseEvent evt) {
        startbttn.setBackground(new java.awt.Color(102, 204, 255)); 
        startbttn.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
    }

    public void mouseExited(java.awt.event.MouseEvent evt) {
        startbttn.setBackground(new java.awt.Color(153, 204, 255)); 
        startbttn.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
    }
});
    ...
    private void initComponents() {
        ...
        startbttn.setBackground(new java.awt.Color(153, 204, 255));
        startbttn.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
        startbttn.setText("Start");
        startbttn.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        startbttn.setBorderPainted(false);
        startbttn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                startbttnActionPerformed(evt);
            }
        });
        jPanel1.add(startbttn, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 460, 140, 40));

        jLabel3.setFont(new java.awt.Font("Segoe Print", 0, 18)); // NOI18N
        jLabel3.setText("Videoke Rental Management System");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/welcomeeguireal.png"))); // NOI18N
